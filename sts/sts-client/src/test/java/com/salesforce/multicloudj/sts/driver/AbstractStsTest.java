...
public class AbstractStsTest {
  ...
  public void testInvalidCredentialScopeWithNonStorageResource() {
    ...
    assertEquals(
        "Credential scope resource must start with 'storage://'. Found: compute://my-instance",
  ...
  public void testInvalidCredentialScopeWithNonStoragePermission() {
    ...
    assertEquals(
        "Credential scope permission must start with 'storage:'. Found: compute:StartInstance",
        exception.getMessage());
  }
  ...
  public void testInvalidCredentialScopeWithNonStorageConditionPrefix() {
    ...
    assertEquals(
        "Credential scope condition resourcePrefix must start with 'storage://'. Found:"
            + " compute://my-instance/logs/",
        exception.getMessage());
  }
  ...
  public void testNullCredentialScopeIsValid() {
    ...
    AssumedRoleRequest request = AssumedRoleRequest.newBuilder().withRole("test-role").build();
